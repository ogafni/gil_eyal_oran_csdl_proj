...
class Disco_with_riskGAN(DiscoGAN):
    ...
    def calculate_losses(self, A, B, one_sample_A, one_sample_B, one_sample_index):
        ...
        indiv_gan_rate = self.args.indiv_gan_rate
        gen_loss_B_2 += indiv_gan_rate*one_sample_gen_loss_B_2
        fm_loss_B_2 += indiv_gan_rate*one_sample_fm_loss_B_2
        recon_loss_A_2 += indiv_gan_rate*one_sample_recon_loss_A_2

        gen_loss_A_2 += indiv_gan_rate*one_sample_gen_loss_A_2
        fm_loss_A_2 += indiv_gan_rate*one_sample_fm_loss_A_2
        recon_loss_B_2 += indiv_gan_rate*one_sample_recon_loss_B_2
