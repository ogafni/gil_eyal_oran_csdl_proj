...
class Options(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--pretrained_g1_path_A', type=str, default='/media/data2/sagieb/DistanceGAN_risk/results/male_female_reg_exps/male_female_models_num_layers_4_second_5/celebA/Male/discogan/Generator_1/')
        self.parser.add_argument('--pretrained_g1_path_B', type=str, default='/media/data2/sagieb/DistanceGAN_risk/results/male_female_reg_exps/male_female_models_num_layers_4_second_5/celebA/Male/discogan/Generator_1/')
