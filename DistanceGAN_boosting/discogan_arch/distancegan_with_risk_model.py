...
from discogan_with_risk_model import Disco_with_riskGAN
from model import *
from dataset import *
...
class Distance_with_riskGAN(Disco_with_riskGAN):
    ...
    def calculate_losses(self, A, B):
        ...
        if not self.args.use_self_distance:
            self.loss_distance_A_1, self.loss_distance_B_1 = self.get_distance_losses(A, B, AB_1, BA_1)
            self.loss_distance_A_2, self.loss_distance_B_2 = self.get_distance_losses(A, B, AB_2, BA_2)
        else:
            self.loss_distance_A_1, self.loss_distance_B_1 = self.get_self_distances(A, B, AB_1, BA_1)
            self.loss_distance_A_2, self.loss_distance_B_2 = self.get_self_distances(A, B, AB_2, BA_2)
        ...
        non_gan_loss_A_1 = self.loss_distance_A_1
        non_gan_loss_B_1 = self.loss_distance_B_1

        if self.args.use_reconst_loss:
            non_gan_loss_A_1 += recon_loss_A_1
            non_gan_loss_B_1 += recon_loss_B_1

        non_gan_loss_A_2 = self.loss_distance_A_2
        non_gan_loss_B_2 = self.loss_distance_B_2

        if self.args.use_reconst_loss:
            non_gan_loss_A_2 += recon_loss_A_2
            non_gan_loss_B_2 += recon_loss_B_2

        gen_loss_A_1_total = (gen_loss_B_1 * 0.1 + fm_loss_B_1 * 0.9) * (1. - rate) + non_gan_loss_A_1 * rate
        gen_loss_B_1_total = (gen_loss_A_1 * 0.1 + fm_loss_A_1 * 0.9) * (1. - rate) + non_gan_loss_B_1 * rate

        gen_loss_A_2_total = (gen_loss_B_2 * 0.1 + fm_loss_B_2 * 0.9) * (1. - rate) + non_gan_loss_A_2 * rate + correlation_loss_AB_2 * correlation_rate
        gen_loss_B_2_total = (gen_loss_A_2 * 0.1 + fm_loss_A_2 * 0.9) * (1. - rate) + non_gan_loss_B_2 * rate + correlation_loss_BA_2 * correlation_rate
        ...
        return (gen_loss_1, dis_loss_1, gen_loss_2, dis_loss_2), \
               ...
               non_gan_loss_A_1, non_gan_loss_B_1, non_gan_loss_A_2, non_gan_loss_B_2,
    ...
    def run(self):
        ...
        for epoch in range(self.args.epoch_size):
            ...
            for i in range(self.n_batches):
                ...
                (self.gen_loss_1, self.dis_loss_1, self.gen_loss_2, self.dis_loss_2), _ = self.calculate_losses(A, B)

                #######################################################################
                # Calculate Test Losses here #
                #######################################################################

                self.alligned_losses = self.calculate_losses(self.alligned_A, self.alligned_B)
                ...
                self.ground_truth_loss_AB_1 = self.ground_truth_critertion(alligned_AB_1, self.alligned_B)
                self.ground_truth_loss_BA_1 = self.ground_truth_critertion(alligned_BA_1, self.alligned_A)
                self.ground_truth_loss_AB_2 = self.ground_truth_critertion(alligned_AB_2, self.alligned_B)
                self.ground_truth_loss_BA_2 = self.ground_truth_critertion(alligned_BA_2, self.alligned_A)
    ...
    def finish_iteration(self):
        ...
        if self.iters % self.args.log_interval == 0:
            ...
            alligned_distance_loss_A_1, alligned_distance_loss_B_1, alligned_distance_loss_A_2, alligned_distance_loss_B_2,
            ...
            print "RECON Loss 1:", self.as_np(alligned_distance_loss_A_1.mean()), self.as_np(alligned_distance_loss_B_1.mean())
            ...
            print "---------------------"
            print "GAN Loss 1:", self.as_np(alligned_gan_loss_A_2.mean()), self.as_np(alligned_gan_loss_B_2.mean())
            print "DIS Loss 1:", self.as_np(alligned_dis_loss_A_2.mean()), self.as_np(alligned_dis_loss_B_2.mean())
            print "RECON Loss 1:", self.as_np(alligned_distance_loss_A_1.mean()), self.as_np(alligned_distance_loss_B_2.mean())
            print "Correlation Loss 1:", self.as_np(alligned_correlation_loss_AB_2.mean()), self.as_np(alligned_correlation_loss_BA_2.mean())
            print "Ground truth Loss 1:", self.as_np(self.ground_truth_loss_AB_2.mean()), self.as_np(self.ground_truth_loss_BA_2.mean())
        ...
        if self.iters % self.args.image_save_interval == 0:
            ...
            AB_2 = self.generator_B_1(self.test_A)
            BA_2 = self.generator_A_1(self.test_B)
            ABA_2 = self.generator_A_2(AB_2)
            BAB_2 = self.generator_B_2(BA_2)
