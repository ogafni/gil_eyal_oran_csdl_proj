...
if __name__ == "__main__": # These settings are used since G1 fixed training is not implemented yet
    options = Options(task_name='clustering_debug', dataset='edges2shoes', model_path='/home/gil/MEGA/saved_models',
                      result_path='/home/gil/dl_wolf_git/gil_eyal_oran_csdl_proj/DistanceGAN_boosting/results',epoch_size=78*7)
    disco_gan = DiscoGAN(options)
    data_a, data_b = dataset.get_edges2shoes(test=False, cluster_file='/home/gil/MEGA/saved_models/referece/edges2shoes/kmenas.pkl',cluster_idx=0,is_cluster_A=False)
    data_a_val, data_b_val = dataset.get_edges2shoes(test=True, cluster_file='/home/gil/MEGA/saved_models/referece/edges2shoes/kmenas.pkl',cluster_idx=0,is_cluster_A=False)
